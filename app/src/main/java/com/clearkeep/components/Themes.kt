...
data class ColorMapping(
    ...
    val errorBackground: Color = errorLight,
    ...
    val loginText: Color = Color.White,
    val cursor: Color = grayscaleBlack,
...
fun provideColor(darkTheme: Boolean) = if (darkTheme) {
    ColorMapping(
        ...
        errorBackground = colorBackgroundTextFieldDark,
        ...
        loginText = grayscaleDarkModeGreyLight2,
        cursor =  grayscaleDarkModeGreyLight2,
        isDarkTheme = true
    )
} else {
    ColorMapping()
