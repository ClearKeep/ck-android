...
class GroupService @Inject constructor(
    ...
    suspend fun getGroup(server: Server, groupId: Long): GroupOuterClass.GroupObjectResponse = withContext(Dispatchers.IO)  {
    ...
    suspend fun getJoinedGroups(server: Server): GroupOuterClass.GetJoinedGroupsResponse = withContext(Dispatchers.IO) {
