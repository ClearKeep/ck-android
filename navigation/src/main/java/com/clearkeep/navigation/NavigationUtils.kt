...
object NavigationUtils {
    fun navigateToHomeActivity(context: Context) {
        val intent = Intent(
            context,
            Class.forName("com.clearkeep.presentation.screen.chat.home.MainActivity")
        )
    ...
    fun navigateToAvailableCall(context: Context, isPeer: Boolean) {
        val peerCallActivity = Class.forName("com.clearkeep.features.calls.presentation.peertopeer.InCallPeerToPeerActivity")
        val groupCallActivity = Class.forName("com.clearkeep.features.calls.presentation.InCallActivity")
