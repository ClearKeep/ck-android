...
class CallViewModel @Inject constructor(
    ...
    var mCurrentCallState = MutableLiveData(com.clearkeep.features.calls.presentation.common.CallState.CALLING)
    ...
    override fun onRemoteRenderAdded(connection: JanusConnection) {
        ...
        if (mCurrentCallState.value != com.clearkeep.features.calls.presentation.common.CallState.ANSWERED) {
            mCurrentCallState.postValue(com.clearkeep.features.calls.presentation.common.CallState.ANSWERED)
        }
    }
    ...
    private fun removeRemoteRender(handleId: BigInteger) {
        mCurrentCallState.postValue(com.clearkeep.features.calls.presentation.common.CallState.ENDED)
    }
    ...
    private fun offerPeerConnection(handleId: BigInteger) {
        peerConnectionClient.createPeerConnection(
            ...
            mContext.get()?.let {
                com.clearkeep.features.calls.presentation.common.createVideoCapture(
                    it
                )
            },
            handleId
