package com.clearkeep.features.auth.presentation.advancedsettings
...
import com.clearkeep.features.auth.presentation.login.LoginViewModel
                ...
                AnimatedVisibility(
                    ...
                    Column {
                        ...
                        CKButton(
                            ...
                            enabled = rememberServerUrl.value.trim().isNotBlank() && isLoading.value != true
                        )
                    }
                }
            }
