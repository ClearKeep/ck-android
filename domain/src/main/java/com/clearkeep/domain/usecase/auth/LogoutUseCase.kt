...
class LogoutUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): Boolean {
        ...
        if (response.data?.error.isNullOrBlank()) {
            ...
            val owner = com.clearkeep.domain.model.Owner(server.serverDomain, server.ownerClientId)
    ...
    private suspend fun deleteKey(owner: com.clearkeep.domain.model.Owner, server: com.clearkeep.domain.model.Server, chatGroups: List<com.clearkeep.domain.model.ChatGroup>?) {
        ...
        val senderAddress = CKSignalProtocolAddress(
            com.clearkeep.domain.model.Owner(server.serverDomain, server.ownerClientId),
            RECEIVER_DEVICE_ID
        )
